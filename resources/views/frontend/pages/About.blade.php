...
<section class="container py-5">
    ...
    <div class="row text-center pt-5 pb-3">
        <div class="col-lg-6 m-auto">
            ...
            <p class="justify-center text-left">
                Di Axlir, kami terus berinovasi dan menciptakan keharuman baru yang sesuai dengan tren dan 
    ...
    <div class="row text-center pt-5 pb-3">
        <div class="col-lg-6 m-auto">
            ...
            <p class="justify-center text-left">
                ...
                Kami percaya bahwa setiap pelanggan adalah bagian dari keluarga besar Axlir, 
